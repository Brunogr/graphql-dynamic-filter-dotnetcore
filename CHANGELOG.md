...
- Package README on NuGet.org for `DynamicQuery.AspNetCore` and `DynamicQuery.NetFramework`

### Changed

- README documents rename from [Graphql.DynamicFilter](https://www.nuget.org/packages/Graphql.DynamicFilter)
